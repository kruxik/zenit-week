...
## Problem Statement
How Might We sync week-planner data across devices without a backend, using only the user's own Google Drive?
...
1. Deploy `week-planner.html` to GitHub Pages (5 min) → establishes an HTTP origin
