...
- **debug:** Audit log for deletes, tombstones, undo restores and merge losses

### Fixed

- **sw:** Keep the shell refreshable behind a tunnel interstitial
- **days:** Keep dropped state when rescheduling a day-child
